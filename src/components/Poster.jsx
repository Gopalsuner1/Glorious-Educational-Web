  ...
  return (
    <div className={` md:w-[95%] md:p-[50px] shadow-lg shadow-black items-center  rounded-2xl overflow-hidden w-[95%] md:h-[560px] h-[250px] ${style.bgdiv}  flex flex-col justify-center `}>
                  <div className={` flex gap-6 overflow-hidden flex-col w-full md:p-14 justify-center items-center  ${style.anim1}`}>
                     <h1 className={`md:text-[42px] text-[#ffff] text-[22px] mt-5 font-bold ${style.f1 } `}> Glorious Educational Academy</h1>
                     <p className='text-[11px] md:text-[16px] text-[#ffff] '>Founded in 2015, Glorious Educational Academy is a premier co-educational English medium school located in Indore. Affiliated with the M.P. Board, Bhopal, and following the CBSE pattern, we combine academic rigor with a nurturing environment to prepare students for success in every field of life.
